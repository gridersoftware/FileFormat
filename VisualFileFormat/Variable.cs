...
namespace VisualFileFormat
{
    class Variable
    {
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets the number of elements in the variable, if defined by a constant. If Count is greater than 1, the variable is an array. If count is less than one, the number of elements is defined by the value of the variable set in CountRef.")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets the variable that defines the number of elements in the variable. If CountRef is null, the number of elements is a constant and is defined in Count.")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets the type of the variable")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets or sets the name of the variable or constant with which to compare to or assign from.")]
        ...
        public virtual string GetPropertyCode()
        {
            if (Count == 1)
                return "public " + @TypeCode.ToString() + " " + UppercaseName + " { get; private set; }";
            else
                return "public " + @TypeCode.ToString() + "[] " + UppercaseName + " { get; private set; }";
        }
